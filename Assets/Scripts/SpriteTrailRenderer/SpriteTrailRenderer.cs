...
namespace SpriteTrailRenderer
{
    ...
    public class SpriteTrailRenderer : MonoBehaviour
    {
        ...
        public float _trailLifetime;
        public SpawnType _spawnType;

        public float _timeBetweenTrailSpawn;
        ...
        private readonly static List<Color32> _rainbowColors = new List<Color32>
    {
        ...
        private void Start()
        {
            ...
            _proto = SpawnTrailObject();
            _spriteObjects = new ObjectPool<SpriteTrailObject>(_proto, 3, 2);
        }
        ...
        private void OnDestroy()
        {
            ...
            List<SpriteTrailObject> pool = _spriteObjects.ReturnPool();

            foreach (SpriteTrailObject trailObject in pool)
            {
                if (trailObject != null)
                {
